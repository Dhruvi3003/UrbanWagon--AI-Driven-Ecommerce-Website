  ...
  return (
    <div className="w-[100vw] h-[70px] bg-[#ecfafaec] z-10 fixed top-0 flex  items-center justify-between px-[30px] shadow-md shadow-black ">
      ...
      <div className="w-[30%] flex items-center justify-end gap-[20px]">
        ...
        />
        <p className="absolute w-[18px] h-[18px] items-center  justify-center bg-black px-[6px] py-[3px] text-white  rounded-full text-[9px] top-[10px] right-[23px] hidden md:block">
          {getCartCount()}
        </p>
      </div>
      {showSearch && (
      ...
      >
        <button
          className="text-[white] flex items-center justify-center flex-col gap-[2px] cursor-pointer"
          onClick={() => navigate("/")}
        >
        ...
        <button
          ...
          onClick={() => navigate("collection")}
        >
          <BiCollection className="w-[28px] h-[28px] text-[white] md:hidden" />{" "}
          Collections
        </button>
        <button
          className="text-[white] flex items-center justify-center flex-col gap-[2px] cursor-pointer "
